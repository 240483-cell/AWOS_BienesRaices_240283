# AWOS_BienesRaices_240483
Repositorio del código fuente del proyecto de clase, Sistema de Bienes Raíces.
...
|---|---|---|---|
|1.| Configuración inicial del Proyecto (NodeJS) | 2 | ✅ Finalizada |
|2.| Routing y Requests (Peticiones) | 5 | ✅ Finalizada |
|3.| Layouts, Template Engines y Tailwind CSS (Frontend)| 5 | ✅ Finalizada |
...
### Creado por: 
Samuel Ramírez Martínez - 240483.